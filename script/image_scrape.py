...
import os
league_ids = [[13,13],[53,13],[31,12],[19,11],[16,11]] #futhead league IDs and how many pages of results for each league
for j in range(0,5):
    for i in range(1,league_ids[j][1]+1):
        # URL of the webpage to scrape
        url = "https://www.futhead.com/22/players/?club=all&league="+str(league_ids[j][0])+"&page="+str(i)+"&level=all_nif"
